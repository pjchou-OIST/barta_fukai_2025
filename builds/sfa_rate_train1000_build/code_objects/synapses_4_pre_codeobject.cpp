...
const size_t _numnetwork_rate = 8000;
const int64_t target_rate = 3;
...
const size_t _num_postsynaptic_idx = _dynamic_array_synapses_4__synaptic_post.size();
    ...
    double* __restrict  _ptr_array_neurongroup_network_rate = _array_neurongroup_network_rate;
    ...
    const double _lio_1 = 0.0 - target_rate;
    ...
    #pragma omp master
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const double network_rate = _ptr_array_neurongroup_network_rate[_postsynaptic_idx];
            double w = _ptr_array_synapses_4_w[_idx];
            const double x_post = _ptr_array_neurongroup_x[_postsynaptic_idx];
            gi += nS * w;
            w += learning_rate * ((_lio_1 + network_rate) * (1.0 + x_post));
