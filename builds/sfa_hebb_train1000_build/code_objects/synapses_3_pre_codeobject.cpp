...
const size_t _numw = _dynamic_array_synapses_3_w.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_synapses_3__synaptic_post.size();
    ...
    #pragma omp master
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            double ge = _ptr_array_neurongroup_1_ge[_postsynaptic_idx];
            const double w = _ptr_array_synapses_3_w[_idx];
            ge += nS * w;
            _ptr_array_neurongroup_1_ge[_postsynaptic_idx] = ge;
