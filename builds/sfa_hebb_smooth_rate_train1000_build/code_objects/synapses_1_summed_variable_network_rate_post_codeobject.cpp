...
void _run_synapses_1_summed_variable_network_rate_post_codeobject()
{
...
const size_t _numnetwork_rate_post = 8000;
const size_t _numr_pre = 1;
...
const size_t _num_presynaptic_idx = _dynamic_array_synapses_1__synaptic_pre.size();
    ...
    double*   _ptr_array_neurongroup_2_r = _array_neurongroup_2_r;
    ...
    {
        _ptr_array_neurongroup_network_rate[_target_idx + 0] = 0;
    }
    ...
    for(int _idx=0; _idx<_ptr_array_synapses_1_N[0]; _idx++)
    {
        ...
        const double r_pre = _ptr_array_neurongroup_2_r[_presynaptic_idx];
        const double _synaptic_var = r_pre;

        _ptr_array_neurongroup_network_rate[_ptr_array_synapses_1__synaptic_post[_idx]] += _synaptic_var;
    }
