...
const size_t _numa1 = 8000;
const size_t _numa2 = 8000;
const size_t _numq = 8000;
const size_t _numrech = 8000;
...
const size_t _numnot_refractory = 8000;
    ...
    double* __restrict  _ptr_array_neurongroup_a1 = _array_neurongroup_a1;
    double* __restrict  _ptr_array_neurongroup_a2 = _array_neurongroup_a2;
    double* __restrict  _ptr_array_neurongroup_q = _array_neurongroup_q;
    double* __restrict  _ptr_array_neurongroup_rech = _array_neurongroup_rech;
	...
	for(int32_t _index_events=0; _index_events<_num_events; _index_events++)
	{
        ...
        const double a1 = _ptr_array_neurongroup_a1[_idx];
        const double a2 = _ptr_array_neurongroup_a2[_idx];
        double q = _ptr_array_neurongroup_q[_idx];
        const double rech = _ptr_array_neurongroup_rech[_idx];
