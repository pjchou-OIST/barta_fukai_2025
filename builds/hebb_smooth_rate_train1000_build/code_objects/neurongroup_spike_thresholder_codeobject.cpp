...
const size_t _numbasethr = 8000;
const size_t _numlastspike = 8000;
const double mV = 0.001;
const size_t _nummax_theta = 8000;
...
const size_t _numv = 8000;
    ...
    double* __restrict  _ptr_array_neurongroup_basethr = _array_neurongroup_basethr;
    double* __restrict  _ptr_array_neurongroup_lastspike = _array_neurongroup_lastspike;
    double* __restrict  _ptr_array_neurongroup_max_theta = _array_neurongroup_max_theta;
    ...
    for(size_t _idx=0; _idx<N; _idx++)
    {
        ...
        const double H1 = _ptr_array_neurongroup_H1[_idx];
        const double H2 = _ptr_array_neurongroup_H2[_idx];
        const double basethr = _ptr_array_neurongroup_basethr[_idx];
        const double max_theta = _ptr_array_neurongroup_max_theta[_idx];
