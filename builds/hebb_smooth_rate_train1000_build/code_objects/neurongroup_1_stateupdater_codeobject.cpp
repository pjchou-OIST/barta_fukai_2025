...
const size_t _numgL = 2000;
const size_t _numge = 2000;
const size_t _numgi = 2000;
const size_t _numinhf = 2000;
...
const size_t _numy = 2000;
const size_t _numz = 2000;
    ///// POINTERS ////////////
    ...
    double* __restrict  _ptr_array_neurongroup_1_gL = _array_neurongroup_1_gL;
    ...
    double* __restrict  _ptr_array_neurongroup_1_inhf = _array_neurongroup_1_inhf;
    ...
    double* __restrict  _ptr_array_neurongroup_1_z = _array_neurongroup_1_z;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const double gL = _ptr_array_neurongroup_1_gL[_idx];
        double ge = _ptr_array_neurongroup_1_ge[_idx];
        double gi = _ptr_array_neurongroup_1_gi[_idx];
        const double inhf = _ptr_array_neurongroup_1_inhf[_idx];
        ...
        double z = _ptr_array_neurongroup_1_z[_idx];
        ...
        _ptr_array_neurongroup_1_z[_idx] = z;
