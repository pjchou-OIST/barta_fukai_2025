...
const double tau_rate = 10.0;
    ...
    const double _lio_1 = exp(1.0f*(- dt)/tau_rate);
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        double r = _ptr_array_neurongroup_2_r[_idx];
        const double _r = _lio_1 * r;
        r = _r;
        _ptr_array_neurongroup_2_r[_idx] = r;
